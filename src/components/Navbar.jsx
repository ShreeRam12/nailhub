                ...
                <div className="bg-blue-500 shadow-lg">
                    <div className="container mx-auto flex items-center justify-between py-3 px-5">
                        ...
                        <div className="hidden md:flex md:space-x-5 lg:space-x-10 md:text-md lg:text-lg navfont">
                            <Link to={"/"}
                                className="hover:text-rose-500 text-white duration-500 ease-in-out animate__animated animate__fadeInUp">Home</Link>
                            <Link to={"/services"}
                                className="hover:text-rose-500 text-white duration-500 ease-in-out animate__animated animate__fadeInUp">Services</Link>
                            <Link to={"/gallery"}
                                className="hover:text-rose-500 text-white duration-500 ease-in-out animate__animated animate__fadeInUp">Gallery</Link>
                            <Link to={"/shop"}
                                className="hover:text-rose-500 text-white duration-500 ease-in-out animate__animated animate__fadeInUp">Shop</Link>
                            <Link to="/blogs"
                                className="hover:text-rose-500 text-white duration-500 ease-in-out animate__animated animate__fadeInUp">Blogs</Link>
                            <Link to={"/faq"}
                                className="hover:text-rose-500 text-white duration-500 ease-in-out animate__animated animate__fadeInUp">FAQ</Link>
                            <Link to={"/contactus"}
                                className="hover:text-rose-500 text-white duration-500 ease-in-out animate__animated animate__fadeInUp">Contact
                                Us</Link>
                        </div>
