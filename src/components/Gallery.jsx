        ...
        <div>
            ...
            <div className='gallery'>
                <div className="container mx-auto px-4 py-8 pb-10">
                    <h1 className="text-3xl font-bold text-center mb-8 navfont text-rose-500">Nail Saloon</h1>

                    <h2 className="text-3xl font-bold text-center mb-8 section_font text-rose-500">Our Photo Gallery</h2>
