        ...
        <div>
            ...
            <section className="bg-rose-500 py-10">
                <div className="container mx-auto px-5">
                    <h2 className="text-3xl font-bold text-center text-white mb-8 navfont">Contact Us</h2>
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <div className="space-y-3 navfont">
                                <div className="flex items-center">
                                    ...
                                    <span className="text-white">+91 9342315641</span>
                                </div>
                                <div className="flex items-center">
                                    <i className="fa-solid fa-envelope text-white mr-3"></i>
                                    <span className="text-white">contact@nailhub.com</span>
                                </div>
                                <div className="flex items-center">
                                    <i className="fa-solid fa-location-dot text-white mr-3"></i>
                                    <span className="text-white">123 Nailhub Street, Chennai, TN, India</span>
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <form className="space-y-5 navfont">
                                ...
                                <button type="submit" className="w-full bg-black text-white p-3 rounded-md hover:bg-yellow-300 transition duration-300">
                                    Send Message
                                </button>
                            </form>
                        </div>
